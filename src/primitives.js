...
const stringModel/*: Model<string>*/ = {
  from: value => typeof value === 'string' ?
    succeed(value) :
    fail(castFailure(`Value is not a string (Is ${typeof value} instead)`)),
};

const numberModel/*: Model<number>*/ = {
  from: value => typeof value === 'number' ?
    succeed(value) :
    fail(castFailure(`Value is not a number (Is ${typeof value} instead)`)),
};

const booleanModel/*: Model<boolean>*/ = {
  from: value => typeof value === 'boolean' ?
    succeed(value) :
    fail(castFailure(`Value is not a boolean (Is ${typeof value} instead)`)),
};
